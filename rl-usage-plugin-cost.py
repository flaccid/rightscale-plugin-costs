...
#make sure you add your RightScale refresh token as an environment variable - call it 'my_refresh_token'

#select the ID of your RightScale parent account and your overage rate in USD
rs_acc_parent = '/api/accounts/77624'
rate = 0.035
...
api_endpoint = 'https://us-4.rightscale.com/api/oauth2'
auth_headers =	{'X-API-Version': '1.5'}
auth_payload =		{
	'grant_type': 'refresh_token',
	'refresh_token': os.environ['my_refresh_token']
					}
